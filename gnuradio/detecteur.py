...
class blk(gr.sync_block):
    def __init__(self, samp_rate=10e6, center_freq=868e6, usrp_source=None):
        ...
        self.bandes = [
            {"nom": "LoRa_868MHz",   "freq": 868e6,  "offset": 4.5e6, "samp": 1e6},
            {"nom": "4G_B28_703MHz", "freq": 718e6,  "offset": 0,     "samp": 30e6},
            {"nom": "4G_B20_832MHz", "freq": 847e6,  "offset": 0,     "samp": 30e6},
            {"nom": "4G_B3_1730MHz", "freq": 1730e6, "offset": 0,     "samp": 40e6},
            {"nom": "4G_B3_1765MHz", "freq": 1765e6, "offset": 0,     "samp": 35e6},
            {"nom": "4G_B1_1950MHz", "freq": 1950e6, "offset": 0,     "samp": 56e6},
            {"nom": "4G_B7_2517MHz", "freq": 2517e6, "offset": 0,     "samp": 35e6},
            {"nom": "4G_B7_2552MHz", "freq": 2552e6, "offset": 0,     "samp": 35e6},
            {"nom": "WiFi_BT",       "freq": 2400e6, "offset": 0,     "samp": 10e6},
        ]
        self.bande_idx   = 0
        ...
        self.scan_duree  = 15
        print(f"INIT OK - Scan {len(self.bandes)} bandes uplink smartphones")
    ...
    def changer_bande(self):
        ...
        if self.usrp_source is not None:
            try:
                ...
                print(f"--- USRP -> {bande['nom']} ({self.center_freq/1e6:.0f} MHz, {self.samp_rate/1e6:.0f}M) OK ---")
    ...
    def identifier_signal(self, freq_hz, bw_hz, rssi):
        ...
        elif 703 < freq_mhz < 733:
            return "4G_B28_uplink"
        elif 832 < freq_mhz < 862:
            return "4G_B20_uplink"
        elif 1710 < freq_mhz < 1785:
            return "4G_B3_uplink"
        elif 1920 < freq_mhz < 1980:
            return "4G_B1_uplink"
        elif 2500 < freq_mhz < 2570:
            return "4G_B7_uplink"
